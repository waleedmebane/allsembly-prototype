...
`docs/notes.md <https://github.com/waleedmebane/allsembly-prototype/blob/main/docs/notes.md>`_ in the source code repository and shown to some extent in the 
...
positions.  See `docs/notes.md <https://github.com/waleedmebane/allsembly-prototype/blob/main/docs/notes.md>`_ for some further explanation.
...
kept on topic.  Some other details can be found in `docs/notes.md <https://github.com/waleedmebane/allsembly-prototype/blob/main/docs/notes.md>`_ and 
